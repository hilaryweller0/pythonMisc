...
class DorsetRadiosonde(object):
    ...
    def calc_dewpoint(self):
        self.df["Dewpoint"] = dewpoint(
            self.df['Humidity'] / 100 * saturation_vapor_pressure(self.df['Temperature']))
...
if __name__ == '__main__':
    sonde = DorsetRadiosonde("/Users/brianlo/Downloads/MW41-DURLSON-20191026-083151-SynchronizedSoundingData.csv")
    sonde.calc_dewpoint()
    pass
